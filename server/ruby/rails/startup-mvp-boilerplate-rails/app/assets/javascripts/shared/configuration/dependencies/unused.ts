...
if (properties.isDependencyEnabled('animate.css')) {
  let animateCSSStyles = require('!style-loader/useable!css-loader!sass-loader!shared/dependencies/ui/effects/_animate_css.scss');
...
if (properties.isDependencyEnabled('hover.css')) {
  let hoverCSSStyles = require('!style-loader/useable!css-loader!sass-loader!shared/dependencies/ui/effects/_hover.scss');
  hoverCSSStyles.use();
} else {
